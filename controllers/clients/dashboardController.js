...
exports.dashboard = function(req, res,next) {
    ...
    res.render(req.theme_client+'/layouts/index',data);
};
...
exports.change_password_update = function(req, res,next) {
	...
	// req.assert('conf_pass', 'Confirm Password do not match to Password').equals('new_pass');
	// var mappedErrors = req.validationErrors(true);
	// if(mappedErrors){
	// 	req.flash('error',mappedErrors.conf_pass.msg);
	// 	return res.redirect('change_password');
	// }else{
	// 	return res.send('ok');
	// }
